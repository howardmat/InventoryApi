    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Province", x => new { x.IsoCode, x.CountryIsoCode });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvinceIsoCode = table.Column<string>(type: "nvarchar(3)", nullable: true),
                    ProvinceCountryIsoCode = table.Column<string>(type: "nvarchar(2)", nullable: true),
                    CountryId = table.Column<int>(type: "int", nullable: false),
                    CountryIsoCode = table.Column<string>(type: "nvarchar(2)", nullable: false),
                    CreatedUserId = table.Column<int>(type: "int", nullable: true),
                    CreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedUserId = table.Column<int>(type: "int", nullable: true),
                    LastModifiedUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.ProvinceIsoCode, x.ProvinceCountryIsoCode },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_CountryIsoCode",
                table: "Address",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Province_CountryIsoCode",
                table: "Province",
                column: "CountryIsoCode");
